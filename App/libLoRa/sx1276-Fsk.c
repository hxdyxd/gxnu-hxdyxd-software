...
void SX1276FskInit_Debug( void )
{
    ...
    printf("RegPaRamp: write:%02x read:%02x \r\n", SX1276->RegPaRamp, read_single_reg(REG_PARAMP) );
    printf("RegLna: write:%02x read:%02x \r\n", SX1276->RegLna, read_single_reg(REG_LNA) );
